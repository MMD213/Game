...
namespace Rabochiy
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            whiteFigure = new Bitmap(new Bitmap(@"D:\игра по Егорову\e.png"), new Size(cellSize - 10, cellSize - 10));
            blackFigure = new Bitmap(new Bitmap(@"D:\игра по Егорову\k.png"), new Size(cellSize - 10, cellSize - 10));
            goldFigure = new Bitmap(new Bitmap(@"D:\игра по Егорову\z.png"), new Size(cellSize - 10, cellSize - 10));
